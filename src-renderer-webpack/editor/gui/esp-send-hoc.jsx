...
const handleClickEspSend = () => {
    console.log(espTool)
  EditorPreload.openEspSettings(JSON.stringify(espTool));
//   alert('点击了')
...
const EspSendHOC = function (WrappedComponent) {
  class EspSendComponent extends React.Component {
    constructor (props) {
      super(props);
      this.state = {
        title: ''
    ...
    render() {
      ...
      return (
        <WrappedComponent
          clickEspSend={handleClickEspSend}
          {...props}
        />
      );
    }
