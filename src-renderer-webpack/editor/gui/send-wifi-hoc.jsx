...
const handleClickSendWifi = () => {
//   alert('SendWifi')
    EditorPreload.openWifiSettings()
...
const SendWifiHOC = function (WrappedComponent) {
  class SendWifiComponent extends React.Component {
    constructor (props) {
      super(props);
      this.state = {
        title: ''
    ...
    render() {
      ...
      return (
        <WrappedComponent
          clickSendWifi={handleClickSendWifi}
          {...props}
        />
      );
    }
