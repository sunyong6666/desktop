...
navigator.serial.addEventListener("disconnect", (e) => {
  ...
  console.log("断开连接")
  document.getElementById('p2').innerText='连接'
});
...
const handleClickSerialConnect = () => {
  
  // alert('点击了')
  try {
    // alert(getCode())
    // console.log('code:'+getCode())
    EditorPreload.openSerialSettings()
...
const SerialHOC = function (WrappedComponent) {
  class SerialComponent extends React.Component {
    ...
    render() {
      ...
      return (
        <WrappedComponent
          clickSerialConnect={handleClickSerialConnect}
          {...props}
        />
      );
    }
