...
const handleClickBleConnect = async () => {
    

    EditorPreload.openBleSettings()
...
const BleHOC = function (WrappedComponent) {
  class BleComponent extends React.Component {
    ...
    render() {
      ...
      return (
        <WrappedComponent
          clickBleConnect={handleClickBleConnect}
          {...props}
        />
      );
    }
