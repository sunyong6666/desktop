(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~addon-entry-mediarecorder"],{

/***/ "./node_modules/css-loader/index.js!./node_modules/scratch-gui/src/addons/addons/mediarecorder/style.css":
/*!******************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/scratch-gui/src/addons/addons/mediarecorder/style.css ***!
  \******************************************************************************************************/
...
/***/ "./node_modules/scratch-gui/src/addons/addons/mediarecorder/_runtime_entry.js":
/*!************************************************************************************!*\
  !*** ./node_modules/scratch-gui/src/addons/addons/mediarecorder/_runtime_entry.js ***!
  \************************************************************************************/
...
/* harmony import */ var _userscript_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userscript.js */ "./node_modules/scratch-gui/src/addons/addons/mediarecorder/userscript.js");
/* harmony import */ var _css_loader_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! css-loader!./style.css */ "./node_modules/css-loader/index.js!./node_modules/scratch-gui/src/addons/addons/mediarecorder/style.css");
...
/***/ "./node_modules/scratch-gui/src/addons/addons/mediarecorder/userscript.js":
/*!********************************************************************************!*\
  !*** ./node_modules/scratch-gui/src/addons/addons/mediarecorder/userscript.js ***!
  \********************************************************************************/
    ...
    const stopRecording = force => {
      ...
      if (force) {
        ...
        recorder.onstop = () => {
          ...
          Object(_libraries_common_cs_download_blob_js__WEBPACK_IMPORTED_MODULE_0__["default"])("".concat(((_addon$tab$redux$stat = addon.tab.redux.state) === null || _addon$tab$redux$stat === void 0 || (_addon$tab$redux$stat = _addon$tab$redux$stat.preview) === null || _addon$tab$redux$stat === void 0 || (_addon$tab$redux$stat = _addon$tab$redux$stat.projectInfo) === null || _addon$tab$redux$stat === void 0 ? void 0 : _addon$tab$redux$stat.title) || "video", ".").concat(fileExtension), blob);
          disposeRecorder();
        };
        recorder.stop();
      }
...
//# sourceMappingURL=vendors~addon-entry-mediarecorder.index.js.map