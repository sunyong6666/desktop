...
let h = "https://localhost/model/pose/model-stride16.json"
...
//        }
            // 画出姿势的骨架连线
//           skeleton.forEach(([part1, part2]) => {
//               const keypoint1 = pose.keypoints.find(kp => kp.part === part1);
//               const keypoint2 = pose.keypoints.find(kp => kp.part === part2);
//
//               // 仅当两个关键点都存在并且置信度较高时才绘制连线
//               if (keypoint1 && keypoint2 && keypoint1.score > 0.6 && keypoint2.score > 0.6) {
//                   ctx.beginPath();
//                   ctx.moveTo(keypoint1.position.x, keypoint1.position.y);
//                   ctx.lineTo(keypoint2.position.x, keypoint2.position.y);
//                   ctx.lineWidth = 2;
//                   ctx.strokeStyle = 'rgba(0, 255, 0, 0.8)';  // 绿色的连线
//                   ctx.stroke();
//               }
//           });
