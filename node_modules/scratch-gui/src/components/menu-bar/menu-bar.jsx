            ...
            >
                <div className={styles.mainMenu}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                        ...
                        {Date.now()-this.lastReciveTime<5000 && this.state.elector==100 && <img
                            src={battery4}
                            draggable={false}
                            width={40}
                            height={40}
                        />}
                        {Date.now()-this.lastReciveTime<5000 && this.state.elector==75 && <img
                            src={battery3}
                            draggable={false}
                            width={40}
                            height={40}
                        />}
                        {Date.now()-this.lastReciveTime<5000 && this.state.elector==50 && <img
                            src={battery2}
                            draggable={false}
                            width={40}
                            height={40}
                        />}
                        {Date.now()-this.lastReciveTime<5000 && this.state.elector==25 && <img
                            src={battery1}
                            draggable={false}
                            width={40}
                            height={40}
