...
class Blocks extends React.Component {
    constructor (props) {
        ...
        this.hiddenBlocksTypes = ['robotsensors_asrStart','robotsensors_asrStop','robotsensors_asrResult','robotevent_when'];
        ...
        this.channelMode.addEventListener('message',(event)=>{
            ...
            if(!this.mode){
                ...
                //恢复
                let toMoveCategory=['robotwifi']
                for (let i = this.deletedCategoriesID.length - 1; i >= 0; i--) {
                    if (toMoveCategory.includes( this.deletedCategoriesID[i])) {
                        this.deletedCategoriesID.splice(i, 1);
                    }
                }
                let toMove=['robotsensors_asrStart','robotsensors_asrStop','robotsensors_asrResult','robotevent_when']
                for (let i = this.hiddenBlocksTypes.length - 1; i >= 0; i--) {
                    if (toMove.includes( this.hiddenBlocksTypes[i])) {
                        this.hiddenBlocksTypes.splice(i, 1);
                    }
                }


                //隐藏
                this.hiddenBlocksTypes.push('robotimg_readColor')
                this.hiddenBlocksTypes.push('robotimg_symFace')
                this.hiddenBlocksTypes.push('robotimg_isSymFace')
                this.hiddenBlocksTypes.push('robotimg_faceName')
                this.hiddenBlocksTypes.push('robotimg_symFacePlace')
                this.hiddenBlocksTypes.push('robotimg_isGood')
                this.hiddenBlocksTypes.push('robotimg_goodPlace')
                this.hiddenBlocksTypes.push('robotimg_isTraffic')
                this.hiddenBlocksTypes.push('robotimg_trafficPlace')
                this.hiddenBlocksTypes.push('robotsensors_cstartsound')
                this.hiddenBlocksTypes.push('robotimg_cstartComputerCamera')
                this.hiddenBlocksTypes.push('robotimg_cstopComputerCamera')
                this.hiddenBlocksTypes.push('robotimg_getQrPlace')
                this.hiddenBlocksTypes.push('robotimg_getQrWh')
                this.hiddenBlocksTypes.push('robotevent_whenPressed')
                this.hiddenBlocksTypes.push('robotimg_csetCamera')
                this.hiddenBlocksTypes.push('robotimg_getFaceWh')
                this.hiddenBlocksTypes.push('robotimg_getGoodWh')
                this.hiddenBlocksTypes.push('robotimg_getColorWh')
                ...
                this.hiddenBlocksTypes.push('robotsensors_asrStart')
                this.hiddenBlocksTypes.push('robotsensors_asrStop')
                this.hiddenBlocksTypes.push('robotsensors_asrResult')
                this.hiddenBlocksTypes.push('robotevent_when')

                let toMove=['robotimg_readColor','robotimg_symFace','robotimg_isSymFace','robotimg_faceName','robotimg_symFacePlace','robotimg_isGood','robotimg_goodPlace','robotimg_isTraffic','robotimg_trafficPlace','robotsensors_cstartsound','robotimg_cstartComputerCamera','robotimg_cstopComputerCamera','robotimg_getQrPlace','robotimg_getQrWh','robotevent_whenPressed','robotimg_csetCamera','robotimg_getFaceWh','robotimg_getGoodWh','robotimg_getColorWh','robotimg_whatPlaceColor','robotimg_isApril','robotimg_getAprilContent','robotimg_getAprilPlace','robotimg_getAprilWh']
                for (let i = this.hiddenBlocksTypes.length - 1; i >= 0; i--) {
                    if (toMove.includes( this.hiddenBlocksTypes[i])) {
                        this.hiddenBlocksTypes.splice(i, 1);
                    }
    ...
    workspaceToCode (event) {
        ...
        if(event.type=='endDrag' || event.type=='change'){
            ...
            try {
                ...
                codeModule.setCode(this.unindentCode(code))
                // console.log(code)
        ...
        try {
            ...
            try{
                dynamicBlocksXML = dynamicBlocksXML.filter(category => {
                    ...
                    return !this.deletedCategoriesID.includes(category.id); // 保留未删除的类别
                });
                ...
                dynamicBlocksXML = dynamicBlocksXML.map(category => {
                    ...
                    for (let i = blocks.length - 1; i >= 0; i--) {
                        const block = blocks[i];
                        if (this.hiddenBlocksTypes.includes(block.getAttribute('type'))) {
        ...
        try {
            ...
            for (let category of categories) {
                if (categoriesToRemove.includes(category.getAttribute('id'))) {
                    this.deletedCategories.push(category);
                    this.deletedCategoriesID.push(category.getAttribute('id'))
                }
            }
